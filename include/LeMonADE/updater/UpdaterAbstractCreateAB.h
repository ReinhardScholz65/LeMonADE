...
--------------------------------------------------------------------------------*/
#ifndef LEMONADE_UPDATER_ABSTRACT_CREATEAB_H
#define LEMONADE_UPDATER_ABSTRACT_CREATEAB_H


/**
 * @file
 *
 * @class UpdaterAbstractCreateAB
 *
...
class UpdaterAbstractCreateAB:public AbstractUpdater
{
public:
  UpdaterAbstractCreateAB(IngredientsType& ingredients_):ingredients(ingredients_){}
...
*/
template < class IngredientsType >
void UpdaterAbstractCreateAB<IngredientsType>::initialize(){
...
*/
template < class IngredientsType >
bool UpdaterAbstractCreateAB<IngredientsType>::execute(){
...
*/
template < class IngredientsType >
void UpdaterAbstractCreateAB<IngredientsType>::cleanup(){
 ...
 */
template<class IngredientsType>
bool UpdaterAbstractCreateAB<IngredientsType>::addSingleMonomer(int32_t type){
 ...
 */
template<class IngredientsType>
bool UpdaterAbstractCreateAB<IngredientsType>::addMonomerToParent(uint32_t parent_id, int32_t type){
  // set properties of add Monomer Move
  MoveAddMonomerSc<> addmove;
  addmove.init(ingredients);
  addmove.setTag(type);
 ...
 */
template<class IngredientsType>
bool UpdaterAbstractCreateAB<IngredientsType>::addMonomerAtPosition(VectorInt3 position, int32_t type){
  MoveAddMonomerSc<> addmove;
  addmove.init(ingredients);
  addmove.setTag(type);
 ...
 */
template<class IngredientsType>
bool UpdaterAbstractCreateAB<IngredientsType>::addMonomerInsideConnectedPair(uint32_t indexA, uint32_t indexB, int32_t type){
 ...
 */
template<class IngredientsType>
bool UpdaterAbstractCreateAB<IngredientsType>::addMonomerAtConnectedPair(uint32_t indexA, uint32_t indexB, int32_t type){
  //first check if monomers are connected
  if( ! ingredients.getMolecules().areConnected(indexA,indexB))
    return false;
 ...
 */
template < class IngredientsType >
bool UpdaterAbstractCreateAB<IngredientsType>::addRing(uint32_t parent, int32_t type, uint32_t NRingMonomers)
  {
 ...
 */
template<class IngredientsType>
void UpdaterAbstractCreateAB<IngredientsType>::moveSystem(int32_t nsteps){
  MoveLocalSc move;
...
template<class IngredientsType>
void UpdaterAbstractCreateAB<IngredientsType>::linearizeSystem(){
 ...
 */
template<class IngredientsType>
VectorInt3 UpdaterAbstractCreateAB<IngredientsType>::randomBondvector(){
  ...
  if(ingredients.getBondset().isValid(bondvector)){
    ...
    throw std::runtime_error("UpdaterAbstractCreateAB::randomBondvector: bondvectors not part of the bondvectorset.");
}
#endif /* LEMONADE_UPDATER_ABSTRACT_CREATEAB_H */
